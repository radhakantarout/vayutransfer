...
// Fixed top bar — logo left, Notifications popup + Profile (now a real
// full-screen destination, not a popup — see /studio/moments/profile) on
// the right — identical on every Moments page. Fully self-contained (own
// pending-count fetch, own notifications popup state) so every page just
// drops in `<TopNavBar />` with no props.
