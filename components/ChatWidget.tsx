...
const SUGGESTIONS = [
  ...
  'How do I request a file from someone?',
...
export default function ChatWidget() {
  ...
  // UploadWidget also sits fixed at bottom-4 right-4 whenever there's a
  // tracked upload — shift this widget up out of its way rather than
  // fight over the same corner (it can grow tall enough to cover a
  // bottom-anchored trigger otherwise).
  const { uploads } = useUpload()
  const uploadWidgetShowing = uploads.length > 0
  ...
  return (
    <>
      ...
      <div
        ...
        `}
        style={{ bottom: uploadWidgetShowing ? '26rem' : '5.5rem', maxHeight: 'min(520px, calc(100vh - 8rem))' }}
      >
        {/* Header */}
        <div className="flex items-center justify-between px-4 py-3 bg-accent flex-shrink-0">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="text-sm font-bold text-white leading-snug">VayuTransfer Assistant</p>
              ...
              <div className="flex gap-2 items-start">
                ...
                <div className="bg-bg border border-border/60 rounded-2xl rounded-tl-sm px-4 py-3 max-w-[260px]">
                  ...
                  <p className="text-xs text-muted leading-relaxed">
                    I'm your VayuTransfer assistant. Ask me anything about sending, receiving, or managing transfers.
                  </p>
                </div>
              </div>
