                          ...
                          {!isFailed && (
                            <div data-no-drag="true" onClick={e => e.stopPropagation()}
                              ...
                              <button onClick={() => toggleStarred(f.fileId, f.curationStatus)}
                                ...
                                className={`flex items-center justify-center p-1 -m-1 rounded-md transition-colors ${f.curationStatus ? 'text-yellow-400' : 'text-text-primary hover:text-text-primary/70'}`}>
                              ...
                              <PhotoActionsMenu
                                align="right"
                                trigger={
                                  <span className="text-text-primary hover:text-text-primary/70 cursor-pointer text-xs leading-none tracking-widest">
                                    •••
                                  </span>
                                }
                                actions={buildPhotoMenuActions(f, idx)}
