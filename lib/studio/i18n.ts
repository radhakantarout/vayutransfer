...
const STRINGS: Record<Exclude<WebsiteLanguage, 'en'>, Dict> = {
  hi: {
    ...
    formErrNameInvalid: 'नाम में केवल अक्षर होने चाहिए, संख्या या प्रतीक नहीं',
  ...
  or: {
    ...
    formErrNameInvalid: 'ନାମରେ କେବଳ ଅକ୍ଷର ରହିବା ଉଚିତ, ସଂଖ୍ୟା କିମ୍ବା ଚିହ୍ନ ନୁହେଁ',
  ...
  bn: {
    ...
    formErrNameInvalid: 'নামে শুধুমাত্র অক্ষর থাকা উচিত, সংখ্যা বা প্রতীক নয়',
  ...
  ta: {
    ...
    formErrNameInvalid: 'பெயரில் எழுத்துக்கள் மட்டுமே இருக்க வேண்டும், எண்கள் அல்லது குறியீடுகள் அல்ல',
  ...
  te: {
    ...
    formErrNameInvalid: 'పేరులో అక్షరాలు మాత్రమే ఉండాలి, సంఖ్యలు లేదా చిహ్నాలు కాదు',
